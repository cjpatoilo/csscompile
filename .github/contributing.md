...
_NOTE: The best way to learn about that is to just install it and give it a try on your code. **CSSCompile** uses an `.editorconfig` file, which most editors support, to enforce these coding standards._
